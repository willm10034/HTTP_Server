...
if __name__ == '__main__':
    ...
    print('<tr><td bgcolor="#ffffff" width="500" height="300"><center><font face="courier" size="-1">Information received<br>Subject: ' + subject + '<br>Message: ' + message + '</font></center></td></tr>')
